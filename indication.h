...
3.active
1.bt ????им?C pairable, connecting, Fast blue flash, no batt or charging indication
2.connected - echo, Fast white flash, no batt or charging indication
3.connected ????им?C pipe, Slow blue flash, with or without batt, depends on charging
...
#define IND_SCANNING					RAINBOW   /*what led will flash**/
