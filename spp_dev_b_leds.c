...
Copyright (C) Cambridge Silicon Radio Ltd. 2006-2009
	...
	BlueLab 4.1.2-Release and provides simple LED indications.
*****************************************************************************/
...
static const int gLedPinsUsed = 0x0807 ; 
...
/*WHITE_ON*/ 
static const ledEntry_t pattern_WHITE_ON [ 1 ] = 
{
    { 0x0007 , ON  , 0    }  
}; 
/*RED_ON*/ 
...
/*RED_GREEN_ON*/ 
static const ledEntry_t pattern_RED_GREEN_ON [ 1 ] = 
{
    { 0x0003 , ON  , 0    }  
}; 
/*GREEN_ON*/ 
static const ledEntry_t pattern_GREEN_ON [ 1 ] = 
{
    { 0x0001 , ON  , 0    }  
}; 
/*BLUE_ON*/ 
...
/*BLUE_FAST_FLASH*/ 
static const ledEntry_t pattern_BLUE_FAST_FLASH [ 2 ] = 
{
    { 0x0004 , ON  , 100  }  , 
    { 0x0004 , OFF , 100  }  
}; 
/*WHITE_FAST_FLASH*/ 
static const ledEntry_t pattern_WHITE_FAST_FLASH [ 2 ] = 
{
    { 0x0007 , ON  , 100  }  , 
    { 0x0007 , OFF , 100  }  
}; 
/*BLUE_SLOW_FLASH*/ 
static const ledEntry_t pattern_BLUE_SLOW_FLASH [ 2 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 3800 }  
}; 
/*BLUE_SLOW_BURST*/ 
static const ledEntry_t pattern_BLUE_SLOW_BURST [ 6 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 100  }  , 
    { 0x0004 , ON  , 200  }  , 
...
/*RED_GREEN_ON_BLUE_SLOW_FLASH*/ 
static const ledEntry_t pattern_RED_GREEN_ON_BLUE_SLOW_FLASH [ 4 ] = 
{
    { 0x0003 , ON  , 2000 }  , 
    { 0x0003 , OFF , 0    }  , 
    { 0x0004 , ON  , 200  }  , 
...
/*GREEN_ON_BLUE_SLOW_FLASH*/ 
static const ledEntry_t pattern_GREEN_ON_BLUE_SLOW_FLASH [ 5 ] = 
{
    { 0x0800 , OFF , 0    }  , 
    { 0x0001 , ON  , 2000 }  , 
    { 0x0001 , OFF , 0    }  , 
...
/*RED_GREEN_BLUE_ALT*/ 
static const ledEntry_t pattern_RED_GREEN_BLUE_ALT [ 6 ] = 
{
    { 0x0002 , ON  , 200  }  , 
    { 0x0002 , OFF , 200  }  , 
    { 0x0001 , ON  , 200  }  , 
...
{
    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_ALL_LEDS_OFF } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_WHITE_ON } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_RED_GREEN_ON } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_GREEN_ON } ,

    {  { 1,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_ON } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_FAST_FLASH } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_WHITE_FAST_FLASH } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_SLOW_FLASH } ,

    {  { 6,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_SLOW_BURST } ,

    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_RED_SLOW_FLASH } ,

    {  { 6,  0x00 , RPT }, (ledEntry_t *) pattern_RED_SLOW_BURST } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON_BLUE_SLOW_FLASH } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_RED_GREEN_ON_BLUE_SLOW_FLASH } ,

    {  { 5,  0x00 , RPT }, (ledEntry_t *) pattern_GREEN_ON_BLUE_SLOW_FLASH } ,
