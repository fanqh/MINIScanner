...
cd C:\Documents and Settings\zzw\×ÀÃæ\NIMIScanner
...
dfubuild -v -pedantic -f combined.dfu -uv 0x0a12 -up 0x0001 -ui "BlueCore firmware version release-1 with application and persistent store" -s stack_signed.xpv -h image.fs -p3 . stack_ps_signed.stack.psr .
